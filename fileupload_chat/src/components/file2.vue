<template>
  <div class="main-body app sidebar-mini">
    ...
    <div class="page">
      <!-- Select Option for Upload and Chat -->
      <div
        class="select-option"
      ...
      <div class="main-content app-content">
        <div class="container-fluid">
          <div class="row main-content-app mb-4 mt-5">
            ...
            <!-- Chat Section -->
            <div class="col-xl-6 col-lg-6 mt-5" v-if="activeSection === 'chat'">
              <div class="main-content-body">
                <div
                  class="mt-5 pt-4"
                  style="width: 80vw; background-color: #fff"
                >
